 ...
 */
 ...
 /*
  * Edit made on line 250 to prevent removal of classes.
  * Alistair Brown <alistair.brown@typecast.com>
  */
    ...
    var GenericContentHandler = ContentHandlerManager.createHandler({
        ...
        removeStyles: function( content ) {
            ...
            content.children().filter(function() {
                ...
                jQuery(this).removeAttr('style')/*.removeClass() AB ~ 11/10/2012 Don't remove classes */;
